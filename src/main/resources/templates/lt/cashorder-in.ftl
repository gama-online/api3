    ...
    <div class="page">
        <div class="subpage">
            ...
            <table border="0" cellspacing="0">
                <tr>
                    <td width="50%">
                        <h2 style="text-transform: uppercase;">Kasos pajamų orderis</h2>
                    </td>
                    <td width="50%">
                        <div class="title">
                            <h2>
            ...
            <table border="0" cellspacing="0">
                <tr>
                    <td width="25%">Suma: </td>
                    <td width="75%"><b><span style="font-size: 110%">${moneyFormatter.text(document.amount)}</span></b></td>
                </tr>
                ...
                <tr>
                    <td>Ūkinės operacijos turinys: </td>
                    <td class="multiline">
                       <b>${document.note!""}</b>
                    </td>
                </tr>
            ...
            <table border="0" cellspacing="0"><tr><td>&#x2702;</td><td width="100%"><hr></td></tr></table>
            ...
            <table border="0" cellspacing="0">
                <tr>
                    <td width="50%">
                        <h2 style="text-transform: uppercase;">Kasos pajamų orderio<br>Kvitas</h2>
                    </td>
                    <td width="50%">
                        <div class="title">
                            <h2>
