...
<head>
    ...
    <style type="text/css">
        *{margin:0;font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;box-sizing:border-box;font-size:14px}
        ...
        .last{margin-bottom:0}.first{margin-top:0}
...
<body itemscope itemtype="http://schema.org/EmailMessage" style="font-family:Helvetica, Arial, sans-serif">
        ...
        <td class="container" width="600" style="display:block !important;max-width:600px !important;margin:0 auto !important;clear:both !important">
            <div class="content" style="max-width:600px;margin:0 auto;display:block;padding:20px">
                <table class="main" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fff;border:1px solid #e9e9e9;border-radius:3px">
                    ...
                    <tr>
                        <td class="content-wrap" style="padding:20px">
                            ...
                            <#if company.code?has_content>Reg. code: <b>${company.code}</b>,</#if>
                            <#if company.vatCode?has_content>VAT code: <b>${company.vatCode}</b></#if>
                            <#if company.address?has_content><br>${company.address}</#if>
                            <#if banks?size == 1>
                                <br>Account: ${banks[0].account}, ${banks[0].bank.name!""}<#if (banks[0].bank.swift)?has_content>, SWIFT:&nbsp;${banks[0].bank.swift}</#if></b>
                            </#if>
                            <#if banks?size gt 1>
                                <br>Accounts:
                                <#list banks as bank>
                                    <br>${bank.account}, ${bank.bank.name!""}<#if (bank.bank.swift)?has_content>, SWIFT:&nbsp;${bank.bank.swift}</#if></b>
                                </#list>
                            </#if>
                        </td>
                    </tr>
                    <tr>
                        <td class="content-wrap" style="padding:20px">
                            ...
                            <#if document.counterparty.comCode?has_content>Reg. code: <b>${document.counterparty.comCode}</b>,</#if>
                            <#if document.counterparty.vatCode?has_content>VAT code: <b>${document.counterparty.vatCode}</b></#if>
                            <#if document.address??>
                                <br>${document.address}
                            </#if>
                        </td>
                    </tr>
                    <tr><td class="content-wrap" style="padding:20px"><b>Due Date: ${document.dueDate}</b></td></tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0" style="width:100%">
                                                        <tr>
                                                            <td style="padding:2px;border-top:2px solid #333"><b>Item Title</b></td>
                                                            <td colspan="2" class="text-center" style="padding:2px;text-center:right;border-top:2px solid #333"><b>Q-ty</b></td>
                                                            <td class="text-right" style="padding:2px;text-align:right;border-top:2px solid #333"><b>Price</b></td>
                                                            <td class="text-right" style="padding:2px;text-align:right;border-top:2px solid #333"><b>Total</b></td>
                                                        </tr>
                                                    <#list document.parts as part>
                                                        <tr>
                                                            <td style="padding:2px;border-top:#eee 1px solid">${translate.translate(part.name, part.translation, "en", "name")!""}</td>
                                                            <td class="text-right text-nowrap" style="padding:2px;text-align:right;border-top:#eee 1px solid">${part.quantity!""}</td>
                                                            <td style="padding:2px;border-top:#eee 1px solid">${translate.translate(part.unit, part.translation, "en", "unit")!""}</td>
                                                        ...
                                                        <#if part.parts??>
                                                            <#list part.parts as partpart>
                                                                <tr class="line">
                                                                    <td style="padding:2px;">&#x25BA;&nbsp; ${translate.translate(partpart.name, partpart.translation, "en", "name")!""} (${part.sku!""})</td>
                                                                    <td class="text-right text-nowrap" style="padding:2px;text-align:right">${partpart.quantity!""}</td>
                                                                    <td style="padding:2px;">${translate.translate(partpart.unit, partpart.translation, "en", "unit")!""}</td>
                                                                    <td colspan="2"></td>
                                                                </tr>
                                                            </#list>
                                                        </#if>
                                                    ...
                                                    <#if company.vatCode?has_content>
                                                        <tr>
                                                            <td colspan="4" class="text-right" style="padding:2px;text-align:right;border-top:2px solid #333"><b>Subtotal w/o VAT:</b></td>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" class="text-right" style="padding:2px;text-align:right"><b>VAT Total:</b></td>
                                                            <td class="text-right text-nowrap" style="padding:2px;text-align:right"><b>${moneyFormatter.formatStd(document.taxTotal)}</b></td>
                                                        </tr>
                                                    </#if>
                                                        <tr>
                                                            <td colspan="4" class="text-right" style="padding:2px;text-align:right"><b>TOTAL<#if company.vatCode?has_content> w/ VAT</#if>:</b></td>
                    ...
                    <tr class="no-print">
                        <td class="content-block text-center" style="text-align:center;padding:0 0 20px">
                            <a href="https://gama-online.appspot.com/workers/print?l=en&0=${document.uuid}" style="color:#348eda;text-decoration:underline">Open and print in browser</a>
                        </td>
                    </tr>
                </table>
                <div class="footer no-print" style="width:100%;clear:both;color:#999;padding:20px">
                    <table width="100%">
                        <tr>
                            <td class="text-center content-block" style="text-align:center;padding:0 0 20px;color:#999;font-size:12px">Document generated by
