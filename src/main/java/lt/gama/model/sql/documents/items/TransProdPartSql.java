...
@Table(name="trans_prod_parts")
public abstract class TransProdPartSql extends BaseCompanySql implements IBaseDocPartCost, IBaseDocPartSql, IDocPart,
    ...
    public TransProdSql getParent() {
        return parent;
    }

    public void setParent(TransProdSql parent) {
        this.parent = parent;
    }
