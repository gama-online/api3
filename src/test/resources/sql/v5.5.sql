...
CREATE TABLE public.entity_money
(
    id bigint NOT NULL,
...
CREATE TABLE public.money_history
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
...
CREATE INDEX idx_money_history_bank_account2_id --v4.0 2021.10.27
    ON public.money_history USING btree
...
CREATE INDEX idx_employee_card_company_id
    ON public.employee_cards USING btree
    (company_id ASC NULLS LAST)
    TABLESPACE pg_default;
...
CREATE TABLE IF NOT EXISTS public.employee_vacation
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
...
CREATE TABLE IF NOT EXISTS public.employee_charge
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
...
CREATE TABLE IF NOT EXISTS public.cash_ob
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cash_ob_balances
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_cash_ob_balances_cash FOREIGN KEY (cash_id)
        REFERENCES public.cash (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE,
    CONSTRAINT fk_cash_ob_balances_parent FOREIGN KEY (parent_id)
        REFERENCES public.cash_ob (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS public.cash_operation
(
    id bigint NOT NULL,
    amount_currency character varying(3) COLLATE pg_catalog."default",
    amount_amount numeric,
...
CREATE TABLE IF NOT EXISTS public.cash_rate_influences
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cash_rate_influences_cash
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_cash_rate_influences_parent FOREIGN KEY (parent_id)
        REFERENCES public.cash_rate_influences (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS public.bank_ob
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.bank_ob_balances
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_bank_ob_balances_parent FOREIGN KEY (parent_id)
        REFERENCES public.bank_ob (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS public.bank_operation
(
    id bigint NOT NULL,
    amount_currency character varying(3) COLLATE pg_catalog."default",
    amount_amount numeric,
...
CREATE TABLE IF NOT EXISTS public.bank_rate_influences
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.bank_rate_influences_bank
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_bank_rate_influences_parent FOREIGN KEY (parent_id)
        REFERENCES public.bank_rate_influences (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS public.employee_ob
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.employee_ob_balances
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_employee_ob_balances_parent FOREIGN KEY (parent_id)
        REFERENCES public.employee_ob (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS public.employee_operation
(
    id bigint NOT NULL,
    amount_currency character varying(3) COLLATE pg_catalog."default",
    amount_amount numeric,
...
CREATE TABLE IF NOT EXISTS public.employee_rate_influences
(
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.employee_rate_influences_employee
(
    id bigint NOT NULL,
    version bigint NOT NULL,
    archive boolean DEFAULT false,
    ...
    CONSTRAINT fk_employee_rate_influences_parent FOREIGN KEY (parent_id)
        REFERENCES public.employee_rate_influences (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT fk_documents_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT fk_documents_employee FOREIGN KEY (employee_id) REFERENCES public.employee(id);

ALTER TABLE ONLY public.debt_ob_counterparties
    ADD CONSTRAINT fk_debt_ob_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

ALTER TABLE ONLY public.debt_rate_influence_counterparties
    ADD CONSTRAINT fk_debt_rate_influence_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

ALTER TABLE ONLY public.debt_coverage
    ADD CONSTRAINT fk_debt_coverage_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

ALTER TABLE ONLY public.debt_history
    ADD CONSTRAINT fk_debt_history_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

ALTER TABLE ONLY public.debt_now
    ADD CONSTRAINT fk_debt_now_counterparty FOREIGN KEY (counterparty_id) REFERENCES public.counterparties(id);

-- v5.5 - created indexes

CREATE INDEX idx_gl_operations_parent ON public.gl_operations USING btree (parent_id);

CREATE INDEX idx_bank_ob_balances_bank_account ON public.bank_ob_balances USING btree (bank_account_id);

CREATE INDEX idx_bank_ob_balances_parent ON public.bank_ob_balances USING btree (parent_id);

CREATE INDEX idx_bank_operation_bank_account ON public.bank_operation USING btree (bank_account_id);

CREATE INDEX idx_bank_operation_bank_account2 ON public.bank_operation USING btree (bank_account2_id);

CREATE INDEX idx_bank_rate_influences_bank_bank_account ON public.bank_rate_influences_bank USING btree (bank_account_id);

CREATE INDEX idx_bank_rate_influences_bank_parent ON public.bank_rate_influences_bank USING btree (parent_id);

CREATE INDEX idx_cash_ob_balances_cash ON public.cash_ob_balances USING btree (cash_id);

CREATE INDEX idx_cash_ob_balances_parent ON public.cash_ob_balances USING btree (parent_id);

CREATE INDEX idx_cash_operation_cash ON public.cash_operation USING btree (cash_id);

CREATE INDEX idx_cash_rate_influences_cash_cash ON public.cash_rate_influences_cash USING btree (cash_id);

CREATE INDEX idx_cash_rate_influences_cash_parent ON public.cash_rate_influences_cash USING btree (parent_id);

CREATE INDEX idx_debt_ob_counterparties_counterparty ON public.debt_ob_counterparties USING btree (counterparty_id);

ALTER TABLE ONLY public.debt_ob_counterparties
    ADD CONSTRAINT fk_debt_ob_counterparties_parent FOREIGN KEY (parent_id) REFERENCES public.debt_opening_balances(id);

CREATE INDEX idx_debt_ob_counterparties_parent ON public.debt_ob_counterparties USING btree (parent_id);

CREATE INDEX idx_debt_rate_influences_counterparties_counterparty ON public.debt_rate_influence_counterparties USING btree (counterparty_id);

ALTER TABLE ONLY public.debt_rate_influence_counterparties
    ADD CONSTRAINT fk_debt_rate_influences_counterparties_parent FOREIGN KEY (parent_id) REFERENCES public.debt_rate_influences(id);

CREATE INDEX idx_debt_rate_influences_counterparties_parent ON public.debt_rate_influence_counterparties USING btree (parent_id);

CREATE INDEX idx_employee_absence_employee ON public.employee_absence USING btree (employee_id);

CREATE INDEX idx_employee_ob_balances_employee ON public.employee_ob_balances USING btree (employee_id);

CREATE INDEX idx_employee_ob_balances_parent ON public.employee_ob_balances USING btree (parent_id);

CREATE INDEX idx_documents_counterparty ON public.documents USING btree (counterparty_id);

CREATE INDEX idx_documents_employee ON public.documents USING btree (employee_id);

CREATE INDEX idx_employee_rate_influences_employee_employee ON public.employee_rate_influences_employee USING btree (employee_id);

CREATE INDEX idx_employee_rate_influences_employee_parent ON public.employee_rate_influences_employee USING btree (parent_id);

CREATE INDEX idx_employee_charge_parent ON public.employee_charge USING btree (parent_id);

CREATE INDEX idx_employee_charge_employee ON public.employee_charge USING btree (employee_id);

CREATE INDEX idx_employee_vacation_employee ON public.employee_vacation USING btree (employee_id);

CREATE INDEX idx_gl_ob_operations_parent ON public.gl_ob_operations USING btree (parent_id);

CREATE INDEX idx_work_hours_employee ON public.work_hours USING btree (employee_id);
