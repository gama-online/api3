...
-- v6.3 2024-03-13
CREATE INDEX IF NOT EXISTS idx_inventory_now_counterparty_id ON inventory_now(counterparty_id);

CREATE INDEX IF NOT EXISTS idx_inventory_history_counterparty_id ON inventory_history(counterparty_id);
CREATE INDEX IF NOT EXISTS idx_inventory_history_origin_counterparty_id ON inventory_history(origin_counterparty_id);
