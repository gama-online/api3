...
(
    ...
    period integer,
    employee_sstax_debit_number character varying(255) COLLATE pg_catalog."default",
    employee_sstax_debit_name character varying(255) COLLATE pg_catalog."default",
    employee_sstax_credit_number character varying(255) COLLATE pg_catalog."default",
    employee_sstax_credit_name character varying(255) COLLATE pg_catalog."default",
    employee_sstax_active boolean,
    employee_sstax_rate numeric,
    company_sstax_debit_number character varying(255) COLLATE pg_catalog."default",
    company_sstax_debit_name character varying(255) COLLATE pg_catalog."default",
    company_sstax_credit_number character varying(255) COLLATE pg_catalog."default",
    company_sstax_credit_name character varying(255) COLLATE pg_catalog."default",
    company_sstax_active boolean,
    company_sstax_rate numeric,
